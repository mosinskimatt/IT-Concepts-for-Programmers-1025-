...
### Logic Gates
A truth table shows every possible outcome you could get from an input. The number 1 tells the transistors to turn on and the number 0 tells the transistors to remain of. EX.
The logic gate AND:
...
The AND gate must consider both inputs of 1 or 0 to give an output of 1. The OR gate output will be 1 if either input is 1. There are seven different logic gates which controls how the transistors on the CPU act and allows “1s” to go through.
